<!--
Title: <type>(<scope>): <action> - #<issue>

Example: fix(player): stop playback when navigation changes - #123
Omit the issue number when there is no related issue.
-->

**Problem:**
<!-- Explain what was wrong or missing and why it matters. Use plain English. -->

**Solution:**
<!-- Explain how this change solves the problem and what now behaves differently. -->
